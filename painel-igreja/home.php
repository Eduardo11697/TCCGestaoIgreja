...
<div class="container-fluid " >
	<section id="minimal-statistics" style="margin-right:20px">
		...
		<div class="row mb-4">
					...
					<div class="card">
						<div class="card-content">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-collection text-warning fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
					...
					<div class="card">
						<div class="card-content">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-box-seam text-info fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
			...
			<div class="col-xl-3 col-sm-6 col-12 mb-2 linkcard <?php echo $esc_pastor ?>"> 
				<a href="index.php?pag=membros">
					<div class="card">
						<div class="card-content">
							<div class="card-body">
			...
			<div class="<?php echo $esc_tesoureiro ?>" align="right"><a href="index.php?mostrar=<?php echo $mostrar ?>" class="text-dark"><i class="bi <?php echo $icone_plus ?>"></i></a></div>
